...
> Replace the images below with your actual screenshots stored in `/docs/screenshots`.
...
![Login Endpoint](docs/screenshots/login-endpoint.png)
...
## 🐾 Create Pet Report API

![Create Pet Report](docs/screenshots/create-pet-report.png)
...
![User Management](docs/screenshots/user-management-api.png)
...
![MongoDB Document](docs/screenshots/mongodb-document.png)

**Show:**

* Sample pet report document
